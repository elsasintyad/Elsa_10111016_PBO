<?php
// <abstract class> (abstract class) didefinisikan sebagai class yang tidak bisa diinstansiasi menjadi object.
...
// Tujuan dari dibuat abstract class adalah agar setiap class turunan menggunakan method abstrak pada class induk.
